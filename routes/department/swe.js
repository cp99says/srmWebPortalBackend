...
const app = express();
const verify_get = require("./../ktr_socp_get");
const verify_post = require("./../ktr_socp_post_swe");
const swe_schema = require("../../models/userDefined/studentDetails_socp_swe");
const facultySchema = require("../../models/userDefined/ktr_facultyDetails_socp_swe");
...
const it_placement = require("./../../models/userDefined/ktr_placementDetails_socp_swe");
const higher_studies = require("./../../models/userDefined/ktr_higher_Studies_socp_swe");
const visitor_details = require("./../../models/userDefined/ktr_visitorDetails_socp_swe");
const patent = require("./../../models/userDefined/ktr_patentDetails_socp_swe");
const project = require("./../../models/userDefined/ktr_projectDetails_socp_swe");
const publication = require("./../../models/userDefined/ktr_publicationDetails_socp_swe");
const student_activity = require("../../models/userDefined/ktr_studentActivities_socp_swe");
const multer = require("multer");
const multerStorage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, "public/ktr/socp/swe");
  },
