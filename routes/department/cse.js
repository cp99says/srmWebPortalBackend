...
app.post('/student_details', verify_post,uploadUserphoto, async (req,res)=>{  
...
app.post('/faculty_details', verify_post,uploadUserphoto ,async (req,res)=>{
...
app.post('/placement_details', verify_post,uploadUserphoto ,async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 
   
        const a= new cse_placement({
...
app.post('/higher_studies', verify_post,uploadUserphoto, async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 

        const a= new higher_studies({            
            students_went_for_higher_studies:req.body.students_went_for_higher_studies,
...
app.post('/visitor_details',verify_post,uploadUserphoto, async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 
...
app.post('/patent_details', verify_post, uploadUserphoto, async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 
...
app.post('/project_details',verify_post, uploadUserphoto ,async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 
...
app.post('/publication_details', verify_post,uploadUserphoto,async (req,res)=>{
...
app.post('/student_activities', verify_post,uploadUserphoto ,async (req,res)=>{
    var b = req.files['0']
    let c = b[b.length - 1]           
    var original=b.originalname 
